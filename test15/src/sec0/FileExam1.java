...
public class FileExam1 {
	...
	public static void main(String[] args) throws IOException {
		String file1 = "d:\\janginbeom\\java3\\a.txt";	// 로컬 경로
		...
		System.out.println("경로를 포함한 파일의 이름(절대 경로) : " + f1.getAbsolutePath());
		System.out.println("경로를 포함한 파일의 이름(상대 경로) : " + f1.getPath());
