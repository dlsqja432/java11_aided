...
// 사용가능한 메소드
// 1. valueOf(String str) - 문자열 str과 일치하는 열거값을 반한
// 2. values() : 열거(값)형 전체를 배열로 반환
// 3. ordinal() : 열거(값)형 순서를 반환
enum Week2 {	
...
public class EnumExam1 {
	public static void main(String[] args) {
		...
		for(Week2 w : arrWeek2) {
			System.out.println((w.ordinal()+1) + "번째 요일 => " + w.getDay());
		}
	}
}
